...
namespace CompiledTasks
{
    public class Form1 : Form
    {
        ...
        private MenuItem RemoveWhiteBoundary;
        private MenuItem Resize;
        private MenuItem DetectEdge;
        ...
        private void InitializeComponent()
        {
            ...
            this.RemoveWhiteBoundary = new System.Windows.Forms.MenuItem();
            this.Resize = new System.Windows.Forms.MenuItem();
            this.DetectEdge = new System.Windows.Forms.MenuItem();
            ...
            this.menuItem6.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] { this.Dilation, 
                this.Erosion, this.RemoveWhiteBoundary});
            ...
            this.menuItem7.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {this.RemoveWhiteBoundary});
            this.menuItem7.Text = "Edit Borders";
            //
            // Boundary removal
            // 
            this.RemoveWhiteBoundary.Index = 0;
            this.RemoveWhiteBoundary.Text = "Remove White Boundaries";
            this.RemoveWhiteBoundary.Click += new System.EventHandler(this.Filter_RemoveWhiteBoundary);
            //
            // menuItem8
            // 
            this.menuItem8.Index = 7;
            this.menuItem8.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {this.Resize, this.DetectEdge});
            this.menuItem8.Text = "Rescale";
            //
            // Resize Horizontally
            // 
            this.Resize.Index = 0;
            this.Resize.Text = "Resize";
            this.Resize.Click += new System.EventHandler(this.Filter_Resize);
            //
            // DetectEdge
            // 
            this.DetectEdge.Index = 1;
            this.DetectEdge.Text = "Detect Shapes";
            this.DetectEdge.Click += new System.EventHandler(this.Filter_Identify);
            // Form1
            // 
        ...
        private void Filter_HorizontalCon(object sender, EventArgs e)
        {
            ...
            m_BitmapClone = BitmapFilter.HorizontalCon(m_BitmapClone, d_Bitmap, true);
        ...
        private void Filter_VerticalCon(object sender, EventArgs e)
        {
            ...
            Bitmap m_BitmapClone = (Bitmap)m_Bitmap.Clone();
            m_Undo = (Bitmap)m_BitmapClone.Clone();
            m_BitmapClone = BitmapFilter.HorizontalCon(m_BitmapClone, d_Bitmap, false);
            m_Bitmap = m_BitmapClone;
        ...
        {
            m_Undo = (Bitmap)m_Bitmap.Clone(); // Save current state for undo
            m_Bitmap = BitmapFilter.Convert1BitTo8Bit(m_Bitmap); // Apply conversion
            this.AutoScrollMinSize = new Size(m_Bitmap.Width, m_Bitmap.Height); // Update scroll size if needed
            this.Invalidate(); // Redraw the form
        }
        private void Filter_Dilation(object sender, System.EventArgs e)
        {
            DlgKernel dlg = new DlgKernel();
            dlg.nValue1 = dlg.nValue2 = 0;
            bool condition = true;
            if (DialogResult.OK == dlg.ShowDialog())
            {
                m_Undo = (Bitmap)m_Bitmap.Clone();
                m_Bitmap = BitmapFilter.Morphology(m_Bitmap, dlg.nValue2, dlg.nValue2, condition); // Apply horizontal concatenation
                Invalidate(); // Redraw the form
            }
        ...
        private void Filter_RemoveWhiteBoundary(object sender, System.EventArgs e)
        {
            m_Undo = (Bitmap)m_Bitmap.Clone();
            m_Bitmap = BitmapFilter.RemoveWhiteBoundary(m_Bitmap, 0); // Apply horizontal concatenation
            Invalidate(); // Redraw the form
            
        }
        private void Filter_Resize(object sender, System.EventArgs e)
        {
            ...
            {
                m_Undo = (Bitmap)m_Bitmap.Clone(); 
                m_Bitmap = BitmapFilter.Resize(m_Bitmap, dlg.nValue); // Apply horizontal concatenation
                Invalidate(); // Redraw the form
            }
        }

        private void Filter_DetectEdge(object sender, System.EventArgs e)
        {
            Threshold dlg = new Threshold();
            dlg.nValue = 0;
            ...
            {
                m_Undo = (Bitmap)m_Bitmap.Clone();
                m_Bitmap = BitmapFilter.DetectEdge(m_Bitmap, dlg.nValue);
                Invalidate();
            }
        }
        private void Filter_Identify(object sender, System.EventArgs e)
        {
            m_Undo = (Bitmap)m_Bitmap.Clone();
            m_Bitmap = BitmapFilter.Identify(m_Bitmap); // Apply horizontal concatenation
            this.AutoScrollMinSize = new Size(m_Bitmap.Width, m_Bitmap.Height); // Update scroll size if needed
            Invalidate(); // Redraw the form
