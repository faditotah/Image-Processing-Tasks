    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.menuItem3.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
                                                                                      this.HorizontalCon,
                                                                                      this.VerticalCon});
            this.menuItem3.Text = "Concatenate Image";
            // 
        ...
        private void Filter_HorizontalCon(object sender, EventArgs e)
        {
            ...
            m_Bitmap = BitmapFilter.HorizontalCon(m_Bitmap, d_Bitmap); // Apply horizontal concatenation
        ...
        private void Filter_VerticalCon(object sender, EventArgs e)
        {
            ...
            m_Undo = (Bitmap)m_Bitmap.Clone(); // Save current state for undo
            m_Bitmap = BitmapFilter.VerticalCon(m_Bitmap, d_Bitmap); // Apply horizontal concatenation
