...
namespace Task1
{
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private System.Windows.Forms.MenuItem BWMean;
        private System.Windows.Forms.MenuItem BWStatic;      
        ...
        private void InitializeComponent()
        {
            ...
            this.BWMean = new System.Windows.Forms.MenuItem();
            this.BWStatic = new System.Windows.Forms.MenuItem();
            ...
            // 
            this.BWMean.Index = 0;
            this.BWMean.Text = "Mean Binarization";
            this.BWMean.Click += new System.EventHandler(this.Filter_BWMean);
            //
            // BW Static
            // 
            this.BWStatic.Index = 1;
            this.BWStatic.Text = "Static Binarization";
            this.BWStatic.Click += new System.EventHandler(this.Filter_BWStatic);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                // Handle the case when m_Bitmap is null
                // For example, you could draw a placeholder image or do nothing
            }
        }
        ...
        private void Filter_BWMean(object sender, System.EventArgs e)
        {
            m_Undo = (Bitmap)m_Bitmap.Clone();
            m_Bitmap = BitmapFilter.BWMean(m_Bitmap); // Apply horizontal concatenation
            this.Invalidate(); // Redraw the form
        }

        private void Filter_BWStatic(object sender, System.EventArgs e)
        {
            ...
            {
                m_Undo = (Bitmap)m_Bitmap.Clone();
                m_Bitmap = BitmapFilter.BWStatic(m_Bitmap, dlg.nValue);
                this.Invalidate();
            }
        }
